# Trade by models:
1. arima
- freqtrade trade --strategy FreqaiExampleHybridStrategy --strategy-path freqtrade/templates --config config_examples/config_freqai.example.json --freqaimodel GridClassificationXC --freqaimodel-path freqtrade/freqai/prediction_models/ 
