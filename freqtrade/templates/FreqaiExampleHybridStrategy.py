...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    sell_rsi = IntParameter(low=100, high=200, default=70, space='sell', optimize=True, load=True)
    short_rsi = IntParameter(low=100, high=200, default=70, space='sell', optimize=True, load=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:  # noqa: C901
        ...
        dataframe['tema'] = ta.TEMA(dataframe, timeperiod=2)
