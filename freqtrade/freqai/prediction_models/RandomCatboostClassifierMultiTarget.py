...
class RandomCatboostClassifierMultiTarget(BaseClassifierModel):
    """
    ...
    def fit(self, data_dictionary: Dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        iterations = [i for i in range(10, 30, 5)]
        ...
        selected_parameter_combinations = random.sample(parameter_combinations, 8)
        for iteration, depth, learning_rate, colsample_bylevel in selected_parameter_combinations:
